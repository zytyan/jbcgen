...
static const json_reflect_type *const types[] = {
    FIELD_TYPE(boolean),
    FIELD_TYPE(plain_char),
    FIELD_TYPE(signed_char),
    FIELD_TYPE(unsigned_char),
    FIELD_TYPE(signed_short),
    FIELD_TYPE(unsigned_short),
    FIELD_TYPE(signed_int),
    FIELD_TYPE(unsigned_int),
    FIELD_TYPE(signed_long),
    FIELD_TYPE(aliased_unsigned_long),
    FIELD_TYPE(signed_long_long),
    FIELD_TYPE(unsigned_long_long),
    FIELD_TYPE(float32),
    FIELD_TYPE(float64),
};
...
static const json_reflect_type enum_type = {
    ...
    .bits = JSON_REFLECT_BASIC_BITS((signed_enum){0}),
    .flags = JSON_REFLECT_BASIC_FLAGS((signed_enum){0}),
